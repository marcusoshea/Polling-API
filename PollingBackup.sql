...
-- Started on 2022-09-13 20:39:38
...
--
-- TOC entry 3397 (class 1262 OID 16394)
...
CREATE TABLE public."PollingOrderMember" (
    ...
    password text,
    polling_order_id integer NOT NULL,
    pom_created_at timestamp without time zone DEFAULT now() NOT NULL
);
...
--
-- TOC entry 3202 (class 2604 OID 16419)
...
--
-- TOC entry 3205 (class 2604 OID 16463)
...
--
-- TOC entry 3207 (class 2604 OID 16484)
...
--
-- TOC entry 3374 (class 0 OID 16416)
-- Dependencies: 214
...
--
-- TOC entry 3383 (class 0 OID 16460)
-- Dependencies: 223
...
COPY public."Polling" (polling_id, name, create_date, end_date, polling_order_id) FROM stdin;
\.
...
COPY public."PollingNotes" (polling_notes_id, note, vote, polling_id, candidate_id, polling_order_id, pn_created_at) FROM stdin;
\.


--
-- TOC entry 3385 (class 0 OID 16481)
-- Dependencies: 225
...
COPY public."PollingOrderMember" (polling_order_member_id, name, email, password, polling_order_id, pom_created_at) FROM stdin;
1	Markus skalpr Grimsson	marcusoshea100@gmail.com	\N	1	2022-09-11 17:37:31.154149
17	Donnan	some@some.com	$2b$10$2Cyk/t9EihvL0AypsJvmNe8kO07zdKZTO.MsZmKT8JpIDq5QqIBIG	1	2022-09-11 23:52:24.558091
\.
...
SELECT pg_catalog.setval('public."PollingOrderMember_polling_order_member_id_seq"', 20, true);
...
--
-- TOC entry 3209 (class 2606 OID 16402)
...
--
-- TOC entry 3223 (class 2606 OID 16488)
...
--
-- TOC entry 3212 (class 2606 OID 16414)
...
--
-- TOC entry 3217 (class 1259 OID 16450)
...
--
-- TOC entry 3218 (class 1259 OID 16444)
...
--
-- TOC entry 3210 (class 1259 OID 16502)
...
--
-- TOC entry 3219 (class 1259 OID 16456)
...
--
-- TOC entry 3227 (class 2606 OID 16445)
...
--
-- TOC entry 3224 (class 2606 OID 16512)
...
--
-- TOC entry 3225 (class 2606 OID 16525)
...
-- Completed on 2022-09-13 20:39:38
